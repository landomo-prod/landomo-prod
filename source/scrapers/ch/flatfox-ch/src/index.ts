...
const PORTAL = 'flatfox-ch';

const log = createLogger({ service: 'flatfox-ch-scraper', portal: PORTAL, country: 'ch' });
...
app.listen(PORT, '0.0.0.0', () => {
  log.info({ port: PORT, workers: WORKER_CONCURRENCY }, 'Flatfox.ch scraper running');
});
