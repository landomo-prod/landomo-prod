...
const PORTAL = 'newhome-ch';

const log = createLogger({ service: 'newhome-ch-scraper', portal: PORTAL, country: 'ch' });
...
app.listen(PORT, '0.0.0.0', () => {
  log.info({ port: PORT, workers: WORKER_CONCURRENCY }, 'Newhome.ch scraper running');
});
