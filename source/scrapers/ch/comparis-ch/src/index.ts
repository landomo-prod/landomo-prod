...
const PORTAL = 'comparis-ch';

const log = createLogger({ service: 'comparis-ch-scraper', portal: PORTAL, country: 'ch' });
...
app.listen(PORT, '0.0.0.0', () => {
  log.info({ port: PORT, workers: WORKER_CONCURRENCY }, 'Comparis.ch scraper running');
});
