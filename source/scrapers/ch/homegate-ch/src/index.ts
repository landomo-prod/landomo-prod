...
const PORTAL = 'homegate-ch';

const log = createLogger({ service: 'homegate-ch', portal: PORTAL, country: 'ch' });
...
app.listen(PORT, '0.0.0.0', () => {
  log.info({ port: PORT, workers: WORKER_CONCURRENCY }, 'Homegate CH scraper running (Queue-based)');
});
