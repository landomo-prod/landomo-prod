...
const PORTAL = 'immoscout24-ch';

const log = createLogger({ service: 'immoscout24-ch', portal: PORTAL, country: 'ch' });
...
app.listen(PORT, '0.0.0.0', () => {
  log.info({ port: PORT, workers: WORKER_CONCURRENCY }, 'ImmoScout24 CH scraper running (Queue-based)');
});
