...
/**
 * Ingest adapter for Finland (vuokraovi-fi scraper).
 *
 * Sends transformed rental properties to the Finland ingest API.
 * Country code: 'fi'
...
export class IngestAdapter {
  ...
  constructor(portal: string) {
    ...
    this.apiKey = process.env.INGEST_API_KEY || 'dev_key_fi_1';
