...
const PORTAL = 'immoweb';

const log = createLogger({ service: 'immoweb-scraper', portal: PORTAL, country: 'belgium' });
...
app.listen(PORT, '0.0.0.0', () => {
  log.info({ port: PORT, workers: WORKER_CONCURRENCY }, 'Immoweb scraper running');
});
