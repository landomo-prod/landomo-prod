...
be-zimmo:
  build:
    context: .
    dockerfile: scrapers/Belgium/zimmo-be/Dockerfile
  ports:
    - "8211:8211"
  environment:
    PORT: 8211
...
| Setting | Value |
|---------|-------|
| Concurrency | 30 (configurable) |
| Lock duration | 5 minutes |
| Lock renew | 2.5 minutes |
| Job delay | 500-1500ms random jitter |
...
| Results per page | 24 | `fetchData.ts` |
