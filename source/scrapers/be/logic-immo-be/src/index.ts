...
const app = express();
const PORT = parseInt(process.env.PORT || '8213', 10);
const PORTAL = 'logic-immo-be';

const log = createLogger({ service: 'logic-immo-be-scraper', portal: PORTAL, country: 'belgium' });
...
app.listen(PORT, '0.0.0.0', () => {
  log.info({ port: PORT, workers: WORKER_CONCURRENCY }, 'Logic Immo BE scraper running');
});
