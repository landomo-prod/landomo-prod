...
const log = createLogger({ service: 'immoscout24-de', portal: PORTAL, country: 'de' });
...
app.listen(PORT, '0.0.0.0', () => {
  log.info({ port: PORT, workers: WORKER_CONCURRENCY }, 'ImmobilienScout24 DE scraper running (Queue-based)');
});
