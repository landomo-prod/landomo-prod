 ...
 */
export function extractImmoScout24DEChecksumFields(listing: SearchListing): ChecksumFields {
  return {
...
export function createImmoScout24DEChecksum(listing: SearchListing): ListingChecksum {
  ...
  return createListingChecksum('immobilienscout24', portalId, listing, extractImmoScout24DEChecksumFields as any);
}

export function batchCreateImmoScout24DEChecksums(listings: SearchListing[]): ListingChecksum[] {
  return listings.map(createImmoScout24DEChecksum);
}
