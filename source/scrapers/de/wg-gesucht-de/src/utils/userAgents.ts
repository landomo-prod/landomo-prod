 ...
 *
 * WG-Gesucht recommends:
 * - 5-8 second delays between requests to avoid reCAPTCHA
...
/**
 * Get WG-Gesucht-specific headers with rotation
 */
export function getWGGesuchtHeaders(): Record<string, string> {
  ...
  if (Math.random() > 0.5) {
    headers['Referer'] = 'https://www.wg-gesucht.de/';
  }
