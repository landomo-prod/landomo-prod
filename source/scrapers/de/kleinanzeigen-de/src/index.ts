...
const PORTAL = 'kleinanzeigen';

const log = createLogger({ service: 'kleinanzeigen-scraper', portal: PORTAL, country: 'de' });
...
app.listen(PORT, '0.0.0.0', () => {
  log.info({ port: PORT, workers: WORKER_CONCURRENCY }, 'Kleinanzeigen scraper running (Queue-based)');
});
