...
const PORTAL = 'immowelt-de';

const log = createLogger({ service: 'immowelt-de-scraper', portal: PORTAL, country: 'de' });

// Start detail workers - low concurrency for Playwright (memory-heavy)
...
app.listen(PORT, '0.0.0.0', () => {
  log.info({ port: PORT, workers: WORKER_CONCURRENCY }, 'Immowelt.de scraper running (Queue-based)');
});
