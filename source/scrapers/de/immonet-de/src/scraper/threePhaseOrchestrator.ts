...
/**
 * Three-Phase Checksum-Based Scraping Orchestrator for Immonet.de
 *
 * Phase 1: Discovery - paginate search results via Playwright, collect IDs + minimal data
...
export async function runThreePhaseScrape(scrapeRunId?: string): Promise<PhaseStats> {
  ...
  try {
    // Use existing scrapeAll which already handles all categories + pagination
