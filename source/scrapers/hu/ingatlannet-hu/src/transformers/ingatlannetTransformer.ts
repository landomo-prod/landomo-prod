...
import { IngatlannetListing, PROPERTY_TYPE_MAP, TRANSACTION_TYPE_MAP } from '../types/ingatlannetTypes';

/**
 * Transform Ingatlannet.hu listing to StandardProperty format
 */
export function transformIngatlannetToStandard(listing: IngatlannetListing): StandardProperty & Record<string, any> {
  ...
  return {
    ...
    source_platform: 'ingatlannet.hu',
    ...
    details: {
      ...
      renovation_year: undefined, // Ingatlannet.hu doesn't provide renovation year separately
    ...
    available_from: undefined, // Ingatlannet.hu doesn't provide available_from
...
/**
 * Map Ingatlannet.hu property type to standard type
 */
...
/**
 * Map Ingatlannet.hu transaction type to standard type
 */
 ...
 */
function extractFeatures(listing: IngatlannetListing): string[] {
