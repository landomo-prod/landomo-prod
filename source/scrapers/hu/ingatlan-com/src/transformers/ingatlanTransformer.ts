...
import { IngatlanListing, PROPERTY_TYPE_MAP, TRANSACTION_TYPE_MAP } from '../types/ingatlanTypes';

/**
 * Transform Ingatlan.com listing to StandardProperty format
 */
export function transformIngatlanToStandard(listing: IngatlanListing): StandardProperty & Record<string, any> {
  ...
  return {
    ...
    details: {
      ...
      renovation_year: undefined, // Ingatlan.com doesn't provide renovation year separately
    ...
    available_from: undefined, // Ingatlan.com doesn't provide available_from
    ...
    ...({ hungarian_room_count: listing.rooms ? String(listing.rooms) : undefined, hungarian_ownership: normalizeOwnershipType(listing.ownership) } as any),
...
/**
 * Map Ingatlan.com property type to standard type
 */
...
/**
 * Map Ingatlan.com transaction type to standard type
 */
 ...
 */
function extractFeatures(listing: IngatlanListing): string[] {
