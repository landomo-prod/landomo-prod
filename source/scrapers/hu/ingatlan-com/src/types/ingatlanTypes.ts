/**
 * Ingatlan.com Types
 * Based on ingatlan.com API structure and Hungarian real estate standards
 */

export interface IngatlanListing {
  id: string;
...
export interface IngatlanSearchParams {
...
export interface IngatlanApiResponse {
  success: boolean;
  count: number;
  listings: IngatlanListing[];
  page?: number;
  totalPages?: number;
}
