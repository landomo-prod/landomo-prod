...
const PORTAL = 'pararius';

const log = createLogger({ service: 'pararius-scraper', portal: PORTAL, country: 'netherlands' });
...
app.listen(PORT, '0.0.0.0', () => {
  log.info({ port: PORT, workers: WORKER_CONCURRENCY }, 'Pararius scraper running');
});
