...
const PORTAL = 'immowelt-at';

const log = createLogger({ service: 'immowelt-at-scraper', portal: PORTAL, country: 'at' });
...
app.listen(PORT, '0.0.0.0', () => {
  log.info({ port: PORT, workers: WORKER_CONCURRENCY }, 'Immowelt.at scraper running (Queue-based)');
});
