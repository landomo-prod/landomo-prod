/**
 * User agent pool for Willhaben Austria scraper
...
/**
 * Get Willhaben-specific headers with rotation
 */
export function getWillhabenHeaders(csrfToken: string): Record<string, string> {
  ...
  if (Math.random() > 0.5) {
    headers['Referer'] = 'https://www.willhaben.at/iad/immobilien/eigentumswohnung/eigentumswohnung-angebote';
  }
