/**
 * User agent pool for Wohnnet Austria scraper
...
/**
 * Get Wohnnet-specific headers with rotation
 */
export function getWohnnetHeaders(): Record<string, string> {
  ...
  if (Math.random() > 0.5) {
    headers['Referer'] = 'https://www.wohnnet.at/immobilien/';
  }
