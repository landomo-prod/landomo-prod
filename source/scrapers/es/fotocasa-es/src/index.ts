...
const log = createLogger({ service: 'fotocasa-scraper', portal: PORTAL, country: 'spain' });

const WORKER_CONCURRENCY = parseInt(process.env.WORKER_CONCURRENCY || '75');
...
app.listen(PORT, '0.0.0.0', () => {
  log.info({ port: PORT, workers: WORKER_CONCURRENCY }, 'Fotocasa scraper running');
});
