import { OtherPropertyTierI, PropertyLocation } from '@landomo/core';
import { RealingoOffer } from '../../types/realingoTypes';
import { extractAgent } from '../shared/fieldMappers';

export function transformRealingoOthers(offer: RealingoOffer): OtherPropertyTierI {
