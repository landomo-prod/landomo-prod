...
exports.transformRealityApartment = transformRealityApartment;
 ...
 */
function transformRealityApartment(listing) {
    ...
    const czech_disposition = (0, czech_value_mappings_1.normalizeDisposition)(disposition);
    const rawOwnership = info['Vlastnictví'] || info['Forma vlastnictví'];
    const czech_ownership = rawOwnership ? (0, czech_value_mappings_1.normalizeOwnership)(rawOwnership) : undefined;
    const rawFurnished = info['Vybavení'] || info['Zařízení'] || info['Vybavenost'] || info['Zařízení nábytkem'];
    const furnished = rawFurnished ? (0, czech_value_mappings_1.normalizeFurnished)(rawFurnished) : undefined;
    ...
    return ({
        ...
        country_specific: {
            czech: {
                ...
                furnished: rawFurnished ? (0, czech_value_mappings_1.normalizeFurnished)(rawFurnished) : undefined,
                floor_number: floor,
...
function detectApartmentSubtype(disposition, title, description) {
