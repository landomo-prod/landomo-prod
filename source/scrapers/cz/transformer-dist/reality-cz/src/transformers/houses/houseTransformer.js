...
exports.transformRealityHouse = transformRealityHouse;
 ...
 */
function transformRealityHouse(listing) {
    ...
    return ({
        ...
        country_specific: {
            czech: {
                disposition: disposition ? (0, czech_value_mappings_1.normalizeDisposition)(disposition) : undefined,
                ownership: (info['Vlastnictví'] || info['Forma vlastnictví']) ? (0, czech_value_mappings_1.normalizeOwnership)(info['Vlastnictví'] || info['Forma vlastnictví']) : undefined,
                condition: normalizedCondition,
                heating_type: heating_type || undefined,
                construction_type: construction_type || undefined,
                energy_rating: energy_class,
                furnished: info['Vybavení'] ? (0, czech_value_mappings_1.normalizeFurnished)(info['Vybavení']) : undefined,
                renovation_year,
                has_garden
            }
        }
...
function detectHouseSubtype(apiType, title, description) {
