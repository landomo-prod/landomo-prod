 ...
 */
export function extractBezrealitkyChecksumFields(listing: BezRealitkyListingItem): ChecksumFields {
  return {
 ...
 */
export function createBezrealitkyChecksum(listing: BezRealitkyListingItem): ListingChecksum {
  ...
  return createListingChecksum('bezrealitky', portalId, listing, extractBezrealitkyChecksumFields);
}
 ...
 */
export function batchCreateBezrealitkyChecksums(listings: BezRealitkyListingItem[]): ListingChecksum[] {
