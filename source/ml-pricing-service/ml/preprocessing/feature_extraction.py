...
NUMERICAL_COLS = {
    "apartment": [
        ...
        "year_built", "hoa_fees", "latitude", "longitude",
    ],
    "house": [
        "bedrooms", "bathrooms", "sqm_living", "sqm_plot", "stories",
        "rooms", "year_built", "renovation_year", "latitude", "longitude",
    ],
    "land": ["area_plot_sqm", "latitude", "longitude"],
    "commercial": [
        "floor_area", "year_built", "renovation_year", "latitude", "longitude",
    ],
}
...
CATEGORICAL_COLS = {
    "apartment": [
        ...
        "furnished", "city", "transaction_type",
    ],
    "house": [
        "construction_type", "condition", "heating_type", "energy_class",
        "furnished", "city", "transaction_type",
    ],
    "land": ["city", "transaction_type"],
    "commercial": ["condition", "city", "transaction_type"],
}
...
BOOLEAN_COLS = {
    ...
    "house": [
        ...
        "has_terrace", "has_pool", "has_balcony",
    ],
    "land": [],
...
def engineer_features(df: pd.DataFrame, category: str) -> pd.DataFrame:
    ...
    # Price per sqm
    sqm_col = {"apartment": "sqm", "house": "sqm_living", "commercial": "floor_area"}.get(category)
