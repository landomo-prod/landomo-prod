-- ============================================================
-- Migration 043: Add district & neighbourhood to ML Training Views
--
-- Drops and recreates all 4 materialized views to include
-- district and neighbourhood columns from the properties table.
--
-- Depends on: migration 042 (adds neighbourhood column)
--
-- Date: 2026-02-28
-- ============================================================
...
-- ============================================================
DROP MATERIALIZED VIEW IF EXISTS ml_training_features_apartment;
DROP MATERIALIZED VIEW IF EXISTS ml_training_features_house;
DROP MATERIALIZED VIEW IF EXISTS ml_training_features_land;
DROP MATERIALIZED VIEW IF EXISTS ml_training_features_commercial;
...
-- ============================================================
CREATE MATERIALIZED VIEW ml_training_features_house AS
SELECT
  id,
  price,
  currency,
...
-- ============================================================
CREATE MATERIALIZED VIEW ml_training_features_land AS
SELECT
  id,
  price,
  currency,
...
-- ============================================================
CREATE MATERIALIZED VIEW ml_training_features_commercial AS
SELECT
  id,
  price,
  currency,
