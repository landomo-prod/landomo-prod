    ...
    <div className="flex min-h-screen items-center justify-center bg-white px-4">
      <div className="w-full max-w-sm">
        ...
        <div className="mt-4 text-center">
          <Link href="/auth/forgot-password" className="text-sm font-medium text-gray-400 hover:text-[#84CC16] transition-colors">
            Forgot password?
          </Link>
        </div>
        ...
        <p className="mt-4 text-center text-sm font-medium text-gray-500">
          ...
          <Link href="/auth/register" className="font-bold text-[#84CC16] hover:text-[#6aaa10]">
            Sign Up
          </Link>
        </p>
      </div>
